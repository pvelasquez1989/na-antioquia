...
const translations = {
  es: {
    ...
    serveInIpTitle: 'Invitación a servir en IP',
    serveInIpDescription: 'Conoce esta invitación antes de escuchar las cuñas informativas.',
  ...
  en: {
    ...
    serveInIpTitle: 'Invitation to serve in PI',
    serveInIpDescription: 'See this invitation before listening to the informational announcements.',
